...
/usr/bin/v4l2-ctl -c focus_absolute=290
#/usr/bin/v4l2-ctl -c brightness=-40
#/usr/bin/v4l2-ctl -c contrast=5
#/usr/bin/v4l2-ctl -c hue=5
#/usr/bin/v4l2-ctl -c exposure_absolute=200
#/usr/bin/v4l2-ctl -c exposure_auto=3
#/usr/bin/v4l2-ctl -c sharpness=100
#/usr/bin/v4l2-ctl -c gain=15
#/usr/bin/v4l2-ctl -c saturation=65
...
# #vcmd[1]="/usr/bin/v4l2-ctl -c focus_absolute=440"
# #vcmd[2]="/usr/bin/v4l2-ctl -c brightness=-60"
# #vcmd[3]="/usr/bin/v4l2-ctl -c contrast=20"
